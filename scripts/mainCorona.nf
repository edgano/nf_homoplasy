...
params.seqs ="${baseDir}/test/Selected_GWH_Coronavirus_Sequences_2020-3-10-1-58-45.fasta"
...
params.trees ="${baseDir}/results_coronaVirus/guide_trees/*.dnd"
 //"/users/cn/egarriga/datasets/homfam/trees/*.famsaUpgma.dnd" //'*.{FAMSA,CLUSTALO,MAFFT_PARTTREE,famsaUpgma}.dnd"

// which tree methods to run if `trees` == `false`
params.tree_method = "parttreednd0"
...
// output directory
params.outdir = "$baseDir/results_coronaVirus"
...
process progressive_alignment {
    tag "${id}-${align_method}-${tree_method}"
